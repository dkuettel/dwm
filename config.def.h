...
static const char *fonts[]          = { "IosevkaTerm Nerd Font:size=15" };
...
static const char *autostart_term[] = { "term", NULL };
...
//static const char *pavuDownCmd[] = { "pactl", "set-sink-volume", "@DEFAULT_SINK@", "-5%", NULL };
//static const char *pavuUpCmd[] = { "pactl", "set-sink-volume", "@DEFAULT_SINK@", "+5%", NULL };
//static const char *pavuMuteToggleCmd[] = { "pactl", "set-sink-mute", "@DEFAULT_SINK@", "toggle", NULL };
static const char *pavuMuteCmd[] = { "pactl", "set-sink-mute", "@DEFAULT_SINK@", "1", NULL };
static const char *pavuUnmuteCmd[] = { "pactl", "set-sink-mute", "@DEFAULT_SINK@", "0", NULL };
